    ...
    public partial class Form1 : Form
    {
        ...
        private void Actualizador_Tick(object sender, EventArgs e)
        {
            ...
            if (radioButton1.Checked)
            {
                ...
                pos = pal.posCabezal;
                llenarCabezal();
                lblPasos.Text = pal.Num.ToString();
                lblEstado.Text = pal.Estado;
            ...
            else if (radioButton2.Checked)
            {
                ...
                pos = pat.posCabezal;
                llenarCabezal();
                lblPasos.Text = pat.Num.ToString();
                lblEstado.Text = pat.Estado;
                txtCinta.Text = string.Join("-", cinta);
                txtCabezal.Text = string.Join(",", cabezal);
                rtxtCinta.Text = string.Join("", cinta);
                rtxtCinta.Select(pos, 1);
            ...
            else if (radioButton3.Checked)
            {
                ...
                pos = sum.posCabezal;
                llenarCabezal();
                lblPasos.Text = sum.Num.ToString();
                lblEstado.Text = sum.Estado;
                txtCinta.Text = string.Join("-", cinta);
                txtCabezal.Text = string.Join(",", cabezal);
                rtxtCinta.Text = string.Join("", cinta);
                rtxtCinta.Select(pos, 1);
            ...
            else if (radioButton4.Checked)
            {
                ...
                pos = res.posCabezal;
                llenarCabezal();
                lblPasos.Text = res.Num.ToString();
            ...
            else if (radioButton5.Checked)
            {
                ...
                pos = mult.posCabezal;
                llenarCabezal();
                lblPasos.Text = mult.Num.ToString();
                lblEstado.Text = mult.Estado;
                txtCinta.Text = string.Join("-", cinta);
                txtCabezal.Text = string.Join(",", cabezal);
                rtxtCinta.Text = string.Join("", cinta);
                rtxtCinta.Select(pos, 1);
